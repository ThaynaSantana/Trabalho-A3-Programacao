...
public class Detran {
    ...
    public Detran(){
        ...
        Moto well = new Moto("Bonneville Bobber", "JAVA", "Wellington", "Cinza com chamas"); // #5
    ...
    public void Alterar(){
        ...
        if(option == 0){
            ...
            veiculo = BuscaInterna(nome_dono);
            if(veiculo != null){
                // Achou o veiculo!
                ...
                if (modelo == null || placa == null || nome_dono == null || cor == null){
